...
//JsBarcode("#element", "content", {options});
...
var charges = [
    ...
    {
        name: "Driving on Wrong Side of the Road",
        price: 575,
        active: false
    },
    {
        name: "Illegal Window Tint",
        price: 350,
        active: false
    },
    {
        name: "Failure to yield at a Stop Sign",
        price: 450,
        active: false
    },
    {
        name: "Failure to yield at a Traffic Light",
        price: 550,
        active: false
    },
    {
    ...
    {
        name: "Driving with an Unroadworthy Vehicle",
        price: 400,
        active: false
    },
    {
    ...
    {
        name: "Driving with a Forged License/Non Valid License",
        price: 1750,
        active: false
    },
    {
        name: "Failure to Provide License, or Vehicle Registration",
        price: 450,
        active: false
    },
    {
        name: "Driving with Damaged Tires",
        price: 250,
        active: false
    },
    {
        name: "Failure to use Seatbelts",
        price: 250,
        active: false
    },
    {
    ...
    {
        name: "Crossing a Double Yellow Line",
        price: 400,
        active: false
    },
    {
        name: "Impeding Traffic",
        price: 250,
        active: false
    },
    {
        name: "Illegally Parked in the Road",
        price: 375,
        active: false
    },
    {
        name: "Parked between the lines",
        price: 75,
        active: false
    },
    {
        name: "Driving with an Obstructed Windshield and/or Mirrors",
        price: 575,
        active: false
    },
    {
        name: "Failure to pull over when a Emergency Vehicle is passing",
        price: 850,
        active: false
    }
];
...
function loadCharges() {
    for(i = 0; i < charges.length; i++) {
        ...
        element.id = "charge" + i + "-container";
        element.style.height = "4.5vw";
        element.style.border = "1px white solid";

        var element2 = document.createElement("div");
        element2.id = "charge" + i + "-name";
        element2.innerHTML = charges[i].name;
        element2.style.fontSize = "2vw";
        element2.style.marginLeft = "0.5vw";

        if(i == 0) {
            var element3 = document.createElement("div");
            element3.id = "charge" + i + "-price";
            element3.innerHTML = "$50 to $2,000";
            element3.style.fontSize = "1.5vw";
            element3.style.marginLeft = "0.5vw";
            element3.style.color = "green";
        } else {
            var element3 = document.createElement("div");
            element3.id = "charge" + i + "-price";
            element3.innerHTML = "$" + numberWithCommas(charges[i].price);
            element3.style.fontSize = "1.5vw";
            element3.style.marginLeft = "0.5vw";
            element3.style.color = "green";
        }
        
        if(charges[i].price <= 200) {
            element3.style.color = "green";
        } else if(charges[i].price <= 500 && charges[i].price > 200) {
            element3.style.color = "yellow";
        } else if(charges[i].price <= 1000 && charges[i].price > 500) {
            element3.style.color = "orange";
        } else if(charges[i].price <= 2000 && charges[i].price > 1000) {
            element3.style.color = "red";
        }

        if(i == 0) {
            var element4 = document.createElement("span");
            element4.id = "charge" + i + "-checkbox";
            element4.classList.add("material-icons");
            element4.innerHTML = "my_location";
            element4.style.fontSize = "2vw";
            element4.style.position = "absolute";
            element4.style.marginTop = "-2.65vw";
            element4.style.marginLeft = "62vw";
            element4.style.cursor = "pointer";
            element4.style.userSelect = "none";
            element4.setAttribute("onclick", "changeSpeed()");
        } else {
            var element4 = document.createElement("span");
            element4.id = "charge" + i + "-checkbox";
            element4.classList.add("material-icons");
            element4.innerHTML = "check_box_outline_blank";
            element4.style.fontSize = "2vw";
            element4.style.position = "absolute";
            element4.style.marginTop = "-2.65vw";
            element4.style.marginLeft = "62vw";
            element4.style.cursor = "pointer";
            element4.style.userSelect = "none";
            element4.setAttribute("onclick", "changeCharge(" + i + ")");
        }
        
        var mainContainer = document.getElementById("offense-container");
...
function changeCharge(chargeID) {
    if(charges[chargeID].active == true) {
        //If charge is currently active
        document.getElementById("charge" + chargeID + "-checkbox").innerHTML = "check_box_outline_blank";
        charges[chargeID].active = false;
        //Animation
        document.getElementById("charge" + chargeID + "-checkbox").style.fontSize = "2.25vw";
        document.getElementById("charge" + chargeID + "-checkbox").style.marginTop = "-2.825vw";
        document.getElementById("charge" + chargeID + "-checkbox").style.marginLeft = "61.875vw";
        setTimeout(function() {
            document.getElementById("charge" + chargeID + "-checkbox").style.fontSize = "2vw";
        }, 50);
    } else if(charges[chargeID].active == false) {
        //If charge is not currently active
        document.getElementById("charge" + chargeID + "-checkbox").innerHTML = "check_box";
        charges[chargeID].active = true;
        //Animation
        document.getElementById("charge" + chargeID + "-checkbox").style.fontSize = "2.25vw";
        document.getElementById("charge" + chargeID + "-checkbox").style.marginTop = "-2.825vw";
        document.getElementById("charge" + chargeID + "-checkbox").style.marginLeft = "61.875vw";
...
function changeSpeed() {
    if(charges[0].active == true) {
        //If speed is currently active
        document.getElementById("charge0-checkbox").innerHTML = "my_location";
        charges[0].active = false;
    } else if(charges[0].active == false) {
        //If speed is not currently active
        document.getElementById("charge0-checkbox").innerHTML = "done_outline";
        charges[0].active = true;
        //Make everything visible
        document.getElementById("layer1").style.visibility = "visible";
        document.getElementById("layer2").style.visibility = "visible";
        document.getElementById("map-close").style.visibility = "visible";
...
function green() {
    ...
    if(markerCreated == true) {
        ...
        marker.id = "marker";
        marker.setAttribute("class", "material-icons");
        marker.innerHTML = "location_on";
        marker.style.position = "absolute";
        marker.style.top = (y - 35) + "px";
        marker.style.left = (x - 15) + "px";
        marker.style.userSelect = "none";
        marker.style.color = "rgb(255, 81, 81)";
        marker.style.fontSize = "2vw";
...
function randomGeneratedContent() {
    var ran = Math.floor(Math.random() * 1000000000);
    //If ran < 100M, try again like 6 times since i'm lazy I don't feel like making a repeat until function :/
    if(ran < 100000000) {
        ran = Math.floor(Math.random() * 1000000000);
    }
    if(ran < 100000000) {
        ran = Math.floor(Math.random() * 1000000000);
    }
    ...
    document.getElementById("citation-id-value").innerHTML = ran;
    JsBarcode("#citation-barcode", ran, {
        width: "2",
        height: "50",
        font: "interstateregular_comp",
        textPosition: "top",
        background: "transparent"
    });

    document.getElementById("citation-month-value").innerHTML = months[d.getMonth()];
    document.getElementById("citation-day-value").innerHTML = d.getDate();
    document.getElementById("citation-year-value").innerHTML = d.getFullYear();
    var minutes = d.getMinutes();
    if(minutes < 10) {
        minutes = "0" + minutes;
    }
    document.getElementById("citation-time-value").innerHTML = d.getHours() + ":" + minutes;
}

randomGeneratedContent();